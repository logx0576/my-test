...
public class CustomHttpServletResponseWrapper extends HttpServletResponseWrapper implements Serializable {
	...
	public CustomHttpServletResponseWrapper(HttpServletResponse response, OutputStream outputStream) {
		super(response);
		statusCode = 200;
