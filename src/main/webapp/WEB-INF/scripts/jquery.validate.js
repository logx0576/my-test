...
$.extend(jQuery.validator.messages, {
	...
	maxlength : jQuery.format("不能超过 {0}个字符长度"),
	minlength : jQuery.format("请输入最少 {0}个字符长度"),
	rangelength : jQuery.format("请输入介于 {0} 到 {1} 之间的字符长度"),
	range : jQuery.format("请输入介于 {0} 到 {1} 之间的值"),
