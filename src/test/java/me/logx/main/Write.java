...
public class Write {
	...
	private void writeNumberFormatSheet(WritableSheet s) throws WriteException {
		...
		s.addCell(l);
		NumberFormat euroPrefixCurrency = new NumberFormat(NumberFormat.CURRENCY_EURO_PREFIX + " #,###.00",
				NumberFormat.COMPLEX_FORMAT);
		...
		s.addCell(l);
		NumberFormat euroSuffixCurrency = new NumberFormat("#,###.00" + NumberFormat.CURRENCY_EURO_SUFFIX,
				NumberFormat.COMPLEX_FORMAT);
		...
		s.addCell(l);
		NumberFormat dollarCurrency = new NumberFormat(NumberFormat.CURRENCY_DOLLAR + " #,###.00",
				NumberFormat.COMPLEX_FORMAT);
		...
		s.addCell(l);
		NumberFormat japaneseYenCurrency = new NumberFormat(NumberFormat.CURRENCY_JAPANESE_YEN + " #,###.00",
				NumberFormat.COMPLEX_FORMAT);
		...
		NumberFormat fraction3digit1 = new NumberFormat(NumberFormat.FRACTION_THREE_DIGITS,
				NumberFormat.COMPLEX_FORMAT);
		...
		NumberFormat fraction3digit2 = new NumberFormat("# " + NumberFormat.FRACTION_THREE_DIGITS,
				NumberFormat.COMPLEX_FORMAT);
	...
	private void writeLabelFormatSheet(WritableSheet s1) throws WriteException {
		...
		WritableFont arial10ptDoubleUnderline = new WritableFont(WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE,
		...
		WritableFont arial10ptSingleAcc = new WritableFont(WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE,
				WritableFont.NO_BOLD, false, UnderlineStyle.SINGLE_ACCOUNTING);
		...
		WritableFont arial10ptDoubleAcc = new WritableFont(WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE,
				WritableFont.NO_BOLD, false, UnderlineStyle.DOUBLE_ACCOUNTING);
		...
		WritableFont superscript = new WritableFont(WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE,
				WritableFont.NO_BOLD, false, UnderlineStyle.NO_UNDERLINE, Colour.BLACK, ScriptStyle.SUPERSCRIPT);
		WritableCellFormat superscriptFormat = new WritableCellFormat(superscript);
		lr = new Label(1, 15, "superscript", superscriptFormat);
		s1.addCell(lr);

		WritableFont subscript = new WritableFont(WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE,
				WritableFont.NO_BOLD, false, UnderlineStyle.NO_UNDERLINE, Colour.BLACK, ScriptStyle.SUBSCRIPT);
		...
		WritableFont red = new WritableFont(WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE, WritableFont.NO_BOLD,
		...
		WritableFont blue = new WritableFont(WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE, WritableFont.NO_BOLD,
		...
		WritableFont yellow = new WritableFont(WritableFont.ARIAL, WritableFont.DEFAULT_POINT_SIZE,
				WritableFont.NO_BOLD, false, UnderlineStyle.NO_UNDERLINE, Colour.YELLOW);
		...
		lr = new Label(0, 24,
				"A very long label, more than 255 characters\012" + "Rejoice O shores\012" + "Sing O bells\012"
						+ "But I with mournful tread\012" + "Walk the deck my captain lies\012"
						...
						+ "A very long label, more than 255 characters\012" + "Rejoice O shores\012"
	...
	private void writeImageSheet(WritableSheet ws) throws WriteException {
		...
		/*
		 * wi = new WritableImage(0, 60, 5, 5, new
		 * File("resources/somefile.gif")); ws.addImage(wi);
		 */
	}
}
